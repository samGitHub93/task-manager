...
public class DayFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View dayView = inflater.inflate(R.layout.day_fragment, container, false);
        TaskViewModel viewModel = new ViewModelProvider(requireActivity()).get(TaskViewModel.class);
        tasks = TaskSorter.sortByPriority(viewModel.getTasks());
        return dayView;
    }
    ...
    private void createRecyclerView(){
        ...
        recyclerView = requireActivity().findViewById(R.id.recycler_day);
